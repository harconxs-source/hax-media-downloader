...
assert.strictEqual(detectPlatform('https://www.reddit.com/r/test/comments/abc123/example/'), 'reddit');
assert.strictEqual(detectPlatform('https://redd.it/abc123'), 'reddit');
assert.strictEqual(detectPlatform('https://x.com/example'), 'twitter');
