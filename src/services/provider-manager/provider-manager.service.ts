...
import { PinterestProvider } from '../../providers/pinterest/pinterest.provider.ts';
import {
  Platform,
  DownloadOptions,
  MediaInfo,
...
import { pinterestSearchService } from '../pinterest-search/pinterest-search.service.ts';
  ...
  async search(query: string, platform?: Platform): Promise<SearchResultItem[]> {
    if (platform === 'pinterest') {
      ...
      try {
        ...
        // Keep generic provider fallback for Pinterest URLs/other providers.
      }
    }
